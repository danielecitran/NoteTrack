...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (searchParams.get("registered") === "true") {
      setSuccess(
        "Registrierung erfolgreich! Bitte überprüfen Sie Ihre E-Mail für die Bestätigung und melden Sie sich an."
      );
    }
  }, [searchParams]);
        ...
        <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-700 p-8 w-full max-w-md">
          <div className="relative">
            ...
            <div className="mt-6 text-center">
              <Link
                href="/reset-password"
                className="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 font-medium transition-colors duration-300"
              >
                Passwort vergessen?
              </Link>
            </div>
